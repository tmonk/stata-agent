#!/usr/bin/env python3
"""Benchmark backward error scan on a large Stata log file (optimized)."""
import os
import re
import sys
import time
...
def fast_scan_log(filepath: str, chunk_size: int = 65536, max_lines: int = 20) -> str:
...
if __name__ == '__main__':
    ...
    print(f"Backward scan (avg of 5): {avg_ms:.3f} ms (min: {min(times)*1000:.3f} ms)")
